...
class BiFPNLayer(nn.Module):
    ...
    def _forward_fast_attention(self, inputs):
        ...
        p4_up = self.conv4_up.forward(
            self.swish(weight[0] * p4_in + weight[1] * self.p4_upsample(p5_up)))  # [6, 120, 24, 56]
        ...
        p3_out = self.conv3_up.forward(
            self.swish(weight[0] * p3_in + weight[1] * self.p3_upsample(p4_up)))  # [6, 120, 48, 112]
