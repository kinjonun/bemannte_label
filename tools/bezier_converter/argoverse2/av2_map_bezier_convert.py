...
class BezierConverter(object):
    ...
    #                 self.ego_points_and_map_vectors(ped_instance[max_index][:2], ped_instance[max_index + 1][:2],
...
def main():
    save_dir = "/home/sun/Bev/BeMapNet/data/argoverse2/test"
    ann_file = "/home/sun/MapTR/data/argoverse2/sensor/av2_map_infos_test.pkl"
    load_interval = 1

    data = mmcv.load(ann_file, file_format='pkl')
    data_infos = list(sorted(data['samples'], key=lambda e: e['timestamp']))    # e是列表 data['samples'] 中的每个元素
