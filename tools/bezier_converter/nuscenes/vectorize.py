...
class VectorizedLocalMap(object):
    ...
    def gen_vectorized_samples(self, location, ego2global_translation, ego2global_rotation):
        ...
        patch_box = (map_pose[0], map_pose[1], self.patch_size[0], self.patch_size[1])     # (x, y, 60, 30)
        patch_angle = quaternion_yaw(rotation) / np.pi * 180

        # line_geom:  [('road_divider', [<shapely.geometry.linestring.LineString >, <.geometry.linestring.LineString>]),
