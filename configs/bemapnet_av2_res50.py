...
class EXPConfig:
    ...
    map_conf = dict(
        ...
        anno_root="/home/sun/Bev/BeMapNet/data/argoverse2/geo_interval_1",
    ...
    VAL_TXT = [
        "assets/splits/argoverse2/av2_origin_val_list.txt",
    ]
...
class Exp(BaseExp):
    ...
    def _configure_train_dataloader(self):
        ...
        train_set = Argoverse2MapDataset(
            ...
            data_split="training",
            splits_txt="av2_origin_train_list.txt",
        )
    ...
    def _configure_val_dataloader(self):
        ...
        val_set = Argoverse2MapDataset(
            ...
            splits_txt="av2_origin_val_list.txt",
        )
