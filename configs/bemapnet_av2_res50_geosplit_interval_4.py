...
class EXPConfig:
        ...
        bev_decoder=dict(
            ...
            net_kwargs=dict(
                ...
                ipm_proj_conf=dict(
                    ...
                    input_shape=(512, 896)
                    # input_shape=(682, 1152)
                    # input_shape=(852, 1536)
                    # input_shape=(1024, 1792)
                )
            ),
        ),
        ins_decoder=dict(
    ...
    VAL_TXT = [
        "assets/splits/argoverse2/geo_near_splits_interval_4/av2_geosplit_val_interval_4.txt",
    ]


class Exp(BaseExp):
    def __init__(self, batch_size_per_device=1, total_devices=1, max_epoch=60, **kwargs):
    ...
    def _configure_train_dataloader(self):
        ...
        train_set = Argoverse2MapDataset(
            ...
            data_split="training",
            splits_txt="geo_near_splits_interval_4/av2_geosplit_train_interval_4.txt"
        )
    ...
    def _configure_val_dataloader(self):
        ...
        val_set = Argoverse2MapDataset(
            ...
            splits_txt="geo_near_splits_interval_4/av2_geosplit_val_interval_4.txt"
        )
