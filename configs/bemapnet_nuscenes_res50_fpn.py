...
class EXPConfig:
    ...
    ida_conf = dict(resize_dims=(800, 480), up_crop_ratio=0, rand_flip=True, rot_lim=False)    # 12506
    ...
    model_setup = dict(
        ...
        im_backbone=dict(
            ...
            ret_layers=3,    # resnet输出4层， 但保留后3层
            fpn_kwargs=dict(
        ...
        bev_decoder=dict(
            ...
            net_kwargs=dict(
                key='im_nek_features',
                in_channels=768,               # 120*5   fpn_num_filters*5  (p3-p7_out)
                num_camera=6,
                src_shape=(21, 49*6),
                query_shape=(64, 32),
                d_model=512,
